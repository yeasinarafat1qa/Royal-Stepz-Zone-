          ...
          <div className="max-w-3xl">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <button
                ...
                className="rounded-xl bg-amber-500 px-6 py-3 font-bold text-slate-950 transition hover:bg-amber-400 cursor-pointer"
              >
                Shop Collection
              </button>
              ...
              <button
                ...
                className="rounded-xl border border-slate-700 bg-slate-900 px-6 py-3 font-bold text-white transition hover:border-amber-500 cursor-pointer"
              >
                Explore Sneakers
              </button>
            </div>
        ...
        <div className="mb-8 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="flex flex-wrap gap-3">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl border border-slate-700 bg-slate-900 px-4 py-2.5 text-sm font-semibold hover:border-amber-500 cursor-pointer"
            >
            ...
            <div className="relative">
              <select
                ...
                className="appearance-none rounded-xl border border-slate-700 bg-slate-900 py-2.5 pl-4 pr-10 text-sm font-semibold text-white outline-none focus:border-amber-500 cursor-pointer"
              >
        ...
        {filteredProducts.length > 0 ? (
          ...
          <div className="rounded-2xl border border-dashed border-slate-700 bg-slate-900/50 px-6 py-16 text-center">
            ...
            <button
              ...
              className="mt-5 rounded-xl bg-amber-500 px-5 py-2.5 font-bold text-slate-950 hover:bg-amber-400 cursor-pointer"
            >
              Clear Filters
            </button>
          </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4">
          <div className="relative max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-2xl border border-slate-700 bg-slate-900 shadow-2xl">
            <button
              ...
              className="absolute right-4 top-4 z-10 rounded-full bg-slate-950/80 p-2 text-slate-300 hover:text-white cursor-pointer"
            ...
            <div className="grid md:grid-cols-2">
              ...
              <div className="p-6">
                ...
                {detailsProduct.colors && detailsProduct.colors.length > 0 && (
                  <div className="mt-5">
                    <p className="mb-3 text-sm font-semibold text-slate-300">
                      Available Colors
                    </p>
                ...
                <button
                  ...
                  className="mt-7 w-full rounded-xl bg-amber-500 px-5 py-3 font-bold text-slate-950 transition hover:bg-amber-400 disabled:cursor-not-allowed disabled:opacity-70 cursor-pointer"
                >
                  {detailsAdded
                    ? 'Added to Cart ✓'
                    : 'Add to Cart'}
